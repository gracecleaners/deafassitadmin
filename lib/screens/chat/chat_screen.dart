...
class _ChatScreenState extends State<ChatScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      message.content,
                      style:
                          TextStyle(color: isMe ? Colors.white : darkTextColor),
                    ),
                      ...
                      child: _isLoading
                          ...
                          : StreamBuilder<List<Message>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                var messages = snapshot.data!.reversed
                                    .toList(); // Reverse to show latest at bottom
  ...
  void _sendMeetingLink() async {
    ...
    String meetingLink =
        "https://meet.example.com/room-${DateTime.now().millisecondsSinceEpoch}";
